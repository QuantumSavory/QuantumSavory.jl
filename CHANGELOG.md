...
- Add focused register benchmark coverage for register creation, `RegisterNet` creation, and pair initialization across default, Clifford, and QuantumMC representations.
