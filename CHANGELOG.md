...
- Document that network locality is a convention, not a Julia-level check, and point to `channel`, `messagebuffer`, `put!`, `query_wait`, and `querydelete_wait!` as the locality-respecting tools.
