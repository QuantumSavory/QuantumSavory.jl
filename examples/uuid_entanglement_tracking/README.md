...
- **Issue**: [#134 - UUID-based entanglement tracker protocol](https://github.com/QuantumSavory/QuantumSavory.jl/issues/134)
...
- **Pull Request**: [#315](https://github.com/QuantumSavory/QuantumSavory.jl/pull/315)

## Troubleshooting

### Common Issues

1. **UUID not found error**
   - Ensure tracker is running on the correct node
   - Check that entanglement was created before swap

2. **Messages not received**
   - Verify all nodes are connected in the network
   - Ensure trackers are running on all relevant nodes

3. **Swap not happening**
   - Check that SwapperProtUUID has available pairs
   - Verify `nodeL` and `nodeH` filters are correct
...
This will show:
- UUID assignments during pair creation
- Swap operations and measurements
- Message routing and tag updates
- Warnings and errors

## Contributing

Found a bug or have a suggestion? Please open an issue on the [QuantumSavory.jl repository](https://github.com/QuantumSavory/QuantumSavory.jl/issues).
