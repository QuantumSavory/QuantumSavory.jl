...
function ghz_project(net, S, ent)
    ...
    if m1 == 2
        ...
        msg = Tag(EntanglementUpdateX, pair_id(ent[1]), NO_ENTANGLEMENT_ID, hub_idx, ent[1], 1, hub_idx, ent[1], m1)
    ...
    for i in ent[2:end]
        ...
        msg = Tag(EntanglementUpdateZ, pair_id(i), NO_ENTANGLEMENT_ID, hub_idx, i, 1, hub_idx, i, m)
