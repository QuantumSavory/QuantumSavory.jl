...
port = parse(Int, get(ENV, "QS_STATE_EXPLORER_PORT", get(ENV, "QS_SIMPLESWITCH_PORT", "8896")))
interface = get(ENV, "QS_STATE_EXPLORER_IP", get(ENV, "QS_SIMPLESWITCH_IP", "127.0.0.1"))
proxy_url = get(ENV, "QS_STATE_EXPLORER_PROXY", get(ENV, "QS_SIMPLESWITCH_PROXY", ""))
