...
The source code is in the [`examples/firstgenrepeater_lowlevel`](https://github.com/QuantumSavory/QuantumSavory.jl/tree/master/examples/firstgenrepeater_lowlevel) folder.