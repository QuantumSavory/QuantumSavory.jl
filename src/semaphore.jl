...
mutable struct SimpleAsymmetricSemaphore
    nbwaiters::Int
    const lock::Resource
end
SimpleAsymmetricSemaphore(sim) = SimpleAsymmetricSemaphore(0, Resource(sim,1,level=1)) # start locked
...
"""
mutable struct AsymmetricSemaphore
