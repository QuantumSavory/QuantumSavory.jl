...
Open the [V-model index](v-model/index.md) when establishing requirements,
architecture, acceptance criteria, or verification traceability. Do not use working
context as a substitute for normative specification.
...
Choose exactly one starting route. Each route leads directly to a small set of leaves.
...
| Network transport, protocol races, and structured logging | [Network context](context/network/index.md) | State/circuit catalog or backend-only tasks |
