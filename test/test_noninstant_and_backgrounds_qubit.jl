...
kraus_lindblad_test(Depolarization(1.), Z1)
kraus_lindblad_test(Depolarization(1.),Z2)
kraus_lindblad_test(Depolarization(1.),X1)
kraus_lindblad_test(Depolarization(1.),X2)
