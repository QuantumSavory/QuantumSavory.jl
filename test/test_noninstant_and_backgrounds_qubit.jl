...
# kraus_lindblad_test(Depolarization(1.0), Z1)
# kraus_lindblad_test(Depolarization(1.0),Z2)
# kraus_lindblad_test(Depolarization(1.0),X1)
# kraus_lindblad_test(Depolarization(1.0),X2)
