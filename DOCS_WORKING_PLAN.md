...
- [ ] 35. Add a short "Limitations and Roadmap" page from the conclusion. Skipped.
- [x] 36. Remove or soften front-page language that says the docs are barebones and users should read source code.
