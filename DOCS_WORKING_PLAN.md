...
- [ ] 2. Split homepage vs onboarding tutorial: keep `index.md` short and directional, and make `manual.md` the first real tutorial.
- [ ] 3. Add a new "Architecture and Mental Model" explanation page as the main entry point for understanding the library.
